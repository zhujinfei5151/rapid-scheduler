...
public class SchedulerJobManagerTest extends BaseManagerTestCase{
	...
	protected String[] getDbUnitDataFiles() {
		return new String[]{"classpath:common_testdata.xml","classpath:SchedulerJob_testdata.xml"};
	}
	...
	public void crud() {
		SchedulerJob obj = new SchedulerJob();
	  	...
	  	obj.setCron(new java.lang.String("1"));
		...
		assertNotNull(manager.getById(obj.getJobName()));
		
		manager.removeById(obj.getJobName());
		manager.getEntityDao().flush();
