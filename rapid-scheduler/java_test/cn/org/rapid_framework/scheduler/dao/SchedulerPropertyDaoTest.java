...
public class SchedulerPropertyDaoTest extends BaseDaoTestCase{
	
	private SchedulerPropertyDao dao;
	...
	public void findByPageRequest() {
		...
		pageRequest.getFilters().put("configValue", "1");
		pageRequest.getFilters().put("defaultValue", "1");
