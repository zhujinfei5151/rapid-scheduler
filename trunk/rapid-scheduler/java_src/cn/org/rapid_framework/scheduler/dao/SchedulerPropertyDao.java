...
@Component
public class SchedulerPropertyDao extends BaseSpringJdbcDao<SchedulerProperty,java.lang.String>{
	
	//注意: getSqlGenerator()可以生成基本的：增删改查sql语句, 通过这个父类已经封装了增删改查操作
	public Class getEntityClass() {
		return SchedulerProperty.class;
	}
	
	public void save(SchedulerProperty entity) {
...
//		insertWithIdentity(entity,sql); //for sqlserver and mysql
	...
	public Page findByPageRequest(PageRequest<Map> pageRequest) {
		...
		String sql = "select "+ getSqlGenerator().getColumnsSql("t") + " from scheduler_property t where 1=1 "
