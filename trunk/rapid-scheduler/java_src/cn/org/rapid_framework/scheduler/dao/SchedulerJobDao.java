...
@Component
public class SchedulerJobDao extends BaseSpringJdbcDao<SchedulerJob,java.lang.String>{
	...
	public void save(SchedulerJob entity) {
...
//		insertWithIdentity(entity,sql); //for sqlserver and mysql
	...
	public Page findByPageRequest(PageRequest<Map> pageRequest) {
		...
		String sql = "select "+ getSqlGenerator().getColumnsSql("t") + " from scheduler_job t where 1=1 "
				+ "/~ and t.cron = '[cron]' ~/"
